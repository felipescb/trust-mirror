...
},{"process":"../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"src/scenes/VideoScene.js":[function(require,module,exports) {
'use strict';
...
var VideoScene = function () {
  function VideoScene(data, description, container) {
    _classCallCheck(this, VideoScene);
  ...
  _createClass(VideoScene, [{
    ...
    value: function handleVideo() {
      var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.description,
          src = _ref2.src;
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"src/scenes/HypeScene.js":[function(require,module,exports) {
'use strict';
...
var HypeScene = function () {
  function HypeScene(description, container) {
    _classCallCheck(this, HypeScene);

    this.description = description;
    this.container = container;
  }

  _createClass(HypeScene, [{
    key: 'play',
    value: function play() {
...
exports.default = HypeScene;
},{}],"src/scenes/Scene.js":[function(require,module,exports) {
'use strict';
...
var _VideoScene = require('./VideoScene');

var _VideoScene2 = _interopRequireDefault(_VideoScene);

var _HypeScene = require('./HypeScene');

var _HypeScene2 = _interopRequireDefault(_HypeScene);
...
var Scene = function () {
  function Scene(data, description, container) {
    _classCallCheck(this, Scene);

    switch (description.type) {
      case 'media':
        return new _VideoScene2.default(data, description, container);
      case 'hype':
        return new _HypeScene2.default(data, description, container);
    }
  ...
  _createClass(Scene, [{
    ...
    value: function play() {
      ...
      var _scene$background = this.scene.background,
          from = _scene$background.from,
          color = _scene$background.color;

      var background = (0, _jquery2.default)('<div class="background slide-in-' + from + '" style="background-color:' + color + '"></div>');
      background.on('animationend webkitAnimationEnd oAnimationEnd', function () {
        var playingDOM = _this.scene.play(_this.data, _this.onEnd);
        (0, _jquery2.default)(_this.container).append(playingDOM);
      });
      (0, _jquery2.default)(this.container).html(background);
    }
  }]);
...
},{"jquery":"node_modules/jquery/dist/jquery.js","./VideoScene":"src/scenes/VideoScene.js","./HypeScene":"src/scenes/HypeScene.js"}],"src/scenes/BalloonSceneGenerator.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = ballonsPlay;
...
function ballonsPlay(data, onEnd) {
  var player = [];
  ...
  imgs.forEach(function (src, i) {
    ...
    img.src = src;
    var balloon = svg(src);
    var start = Math.random() * 60 + 10;
    var sign = Math.random() > .5 ? 1 : -1;
    var end = Math.min(70, (1 + sign * Math.random() / 5) * start);
    var top = Math.random() * 30 + 10;
    balloon.css({
      left: start + '%',
      top: '100%',
...
function svg(src, i) {
  ...
  return (0, _jquery2.default)(svg);
}
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"src/scenes/Stamps.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = StampsPlay;
...
function StampsPlay(data, onEnd) {
  var wrapper = (0, _jquery2.default)('<div class="wrapper"></div>');
  var strings = data.likes.map(function (like) {
    return like.name;
  });
  ...
  function createStamp() {
    var str = strings.pop();
    popped++;
    var stamp = (0, _jquery2.default)('<div class="stamp">' + str + '</div>');
...
var _BalloonSceneGenerator = require('./scenes/BalloonSceneGenerator');

var _BalloonSceneGenerator2 = _interopRequireDefault(_BalloonSceneGenerator);
...
exports.default = function (data) {
  var HELLO = {
    ...
    attrs: [{
      domGenerator: function domGenerator() {
        var identifier = data.identifier;

        var firstName = identifier.split(' ')[0];
        var tooMany = firstName.length >= 13;
        var hello = tooMany ? '<h1 style="top:10%;font-size:2em; " class="floating">Hello</h1>' : '';
        return '<div style="color:#111">           ' + hello + '\n          <div style="color:#111 ;bottom:71.8%;top:21.7%" class="floating flex-center">' + (tooMany ? '' : 'Hello') + ' ' + firstName + '           </div>';
      },
      in: 2800
    }]
  };
  ...
  var BALLOONS = {
    ...
    scene: {
      ...
      play: _BalloonSceneGenerator2.default
    }
  };
...
var _Scene = require('./scenes/Scene');

var _Scene2 = _interopRequireDefault(_Scene);

var _scenes = require('./scenes.js');
...
var Script = function () {
  ...
  _createClass(Script, [{
    ...
    key: 'createScenes',
    value: function createScenes(data) {
      var _this = this;
...
},{"./scenes/Scene":"src/scenes/Scene.js","./scenes.js":"src/scenes.js"}],"assets/sample.json":[function(require,module,exports) {
module.exports = {
  "_id": "5b963b594782c551b631d6c2",
  "identifier": "Jean-Philippe de Souza",
  "photos": ["https://scontent.xx.fbcdn.net/v/t1.0-9/36952859_2006403629672195_4582597879968825344_n.jpg?_nc_cat=0&oh=def7ecaae51f11589a22e41b1c9ab05d&oe=5C289A2F", "https://scontent.xx.fbcdn.net/v/t31.0-8/18921187_1580568928622457_7200217862863418331_o.png?_nc_cat=0&oh=a793b245dbac4c5d81ea488261b0ee07&oe=5BF3F3E7", "https://scontent.xx.fbcdn.net/v/t1.0-9/297061_229201490462879_703080163_n.jpg?_nc_cat=0&oh=fabe3cd4147da43b1b63c009be90cf17&oe=5C25A407", "https://scontent.xx.fbcdn.net/v/t1.0-9/261544_194932487223113_2892129_n.jpg?_nc_cat=0&oh=7d49c9d91e3add355a0cd19fe411510c&oe=5C2746BF"],
  "likes": [{
    "name": "The Distillers",
    "id": "227808241416402",
    "created_time": "2018-08-26T18:38:10+0000"
  }, {
    "name": "Opu Labs",
    "id": "594790170854801",
    "created_time": "2018-08-12T18:43:56+0000"
  }, {
    "name": "Comyounity",
    "id": "122848368361902",
    "created_time": "2018-08-09T15:42:47+0000"
  }, {
    "name": "INTERLUDE",
    "id": "940489256113178",
    "created_time": "2018-08-02T12:08:28+0000"
  }, {
    "name": "The Psychometrics Centre, University of Cambridge",
    "id": "217121084971171",
    "created_time": "2018-07-13T15:01:23+0000"
  }, {
    "name": "Festival of Dangerous Ideas",
    "id": "558635534500700",
    "created_time": "2018-07-11T15:03:58+0000"
  }, {
    "name": "Quem conta é a água",
    "id": "197377910886348",
    "created_time": "2018-07-07T16:56:21+0000"
  }, {
    "name": "Fondation VASARELY",
    "id": "122094354486335",
    "created_time": "2018-06-03T22:56:33+0000"
  }, {
    "name": "RESPECT IS BURNING",
    "id": "8951162018",
    "created_time": "2018-06-03T22:55:50+0000"
  }, {
    "name": "Street School",
    "id": "1621630124725528",
    "created_time": "2018-05-17T09:08:22+0000"
  }, {
    "name": "Melissa S. McCracken",
    "id": "612254108889961",
    "created_time": "2018-04-23T04:13:49+0000"
  }, {
    "name": "Cyberpunk Is Now",
    "id": "437051623151257",
    "created_time": "2018-04-13T22:16:16+0000"
  }, {
    "name": "Google Cloud Platform",
    "id": "568932726621465",
    "created_time": "2018-03-15T07:19:21+0000"
  }, {
    "name": "VICELAND",
    "id": "878862935569519",
    "created_time": "2018-03-04T23:42:32+0000"
  }, {
    "name": "Mesa & Cadeira",
    "id": "190215337712144",
    "created_time": "2018-02-25T06:55:26+0000"
  }, {
    "name": "Time is Art",
    "id": "496475627058498",
    "created_time": "2018-01-14T02:37:13+0000"
  }, {
    "name": "MIND THE HEADPHONE",
    "id": "383920928381883",
    "created_time": "2018-01-09T05:32:57+0000"
  }, {
    "name": "Zouk Needs You",
    "id": "698911563539435",
    "created_time": "2018-01-05T05:30:05+0000"
  }, {
    "name": "Minerando Dados",
    "id": "181821759010898",
    "created_time": "2018-01-03T14:17:05+0000"
  }, {
    "name": "Thievery Corporation",
    "id": "23018941735",
    "created_time": "2017-12-28T17:27:51+0000"
  }, {
    "name": "theory11",
    "id": "7163962142",
    "created_time": "2017-12-18T18:15:40+0000"
  }, {
    "name": "UP Lab",
    "id": "190466931101942",
    "created_time": "2017-11-29T01:51:58+0000"
  }, {
    "name": "Sven Løve",
    "id": "781307831977003",
    "created_time": "2017-11-17T19:34:08+0000"
  }, {
    "name": "VTEX People",
    "id": "1875231952715975",
    "created_time": "2017-11-01T21:04:29+0000"
  }, {
    "name": "thecamp",
    "id": "1474737612838802",
    "created_time": "2017-10-16T23:18:27+0000"
  }],
  "cached": [{
    "type": "positive",
    ...
    "type": "positive",
    "phrase": "Authority-challenging"
  }, {
    "type": "positive",
    "phrase": "Appreciative of art"
  }, {
    "type": "negative",
    "phrase": "Independent"
  }, {
  ...
  "raw": {
    ...
    "personality": [{
      ...
      "percentile": 0.8861255451047158,
      "raw_score": 0.7871611675644509,
      "significant": true,
      "children": [{
        "trait_id": "facet_adventurousness",
        "name": "Adventurousness",
        "category": "personality",
        "percentile": 0.8733908714488849,
        "raw_score": 0.5454543183229833,
        "significant": true
      }, {
        "trait_id": "facet_artistic_interests",
        "name": "Artistic interests",
        "category": "personality",
        "percentile": 0.9470524627896388,
        "raw_score": 0.7471788019231618,
        "significant": true
      }, {
        "trait_id": "facet_emotionality",
        "name": "Emotionality",
        "category": "personality",
        "percentile": 0.7193189002820236,
        "raw_score": 0.6718743714320141,
        "significant": true
      }, {
        "trait_id": "facet_imagination",
        "name": "Imagination",
        "category": "personality",
        "percentile": 0.9788763914537189,
        "raw_score": 0.8357430750849002,
        "significant": true
      }, {
        "trait_id": "facet_intellect",
        "name": "Intellect",
        "category": "personality",
        "percentile": 0.9985118466723784,
        "raw_score": 0.7447272544034756,
        "significant": true
      }, {
        "trait_id": "facet_liberalism",
        "name": "Authority-challenging",
        "category": "personality",
        "percentile": 0.9533087386035907,
        "raw_score": 0.6007351765704767,
        "significant": true
      }]
    }, {
      ...
      "category": "personality",
      "percentile": 0.27969126991708143,
      "raw_score": 0.6008239926313215,
      "significant": true,
      "children": [{
        "trait_id": "facet_achievement_striving",
        "name": "Achievement striving",
        "category": "personality",
        "percentile": 0.5279339568770128,
        "raw_score": 0.6921086619157661,
        "significant": true
      }, {
        "trait_id": "facet_cautiousness",
        "name": "Cautiousness",
        "category": "personality",
        "percentile": 0.43095701449323587,
        "raw_score": 0.48149371817000536,
        "significant": true
      }, {
        "trait_id": "facet_dutifulness",
        "name": "Dutifulness",
        "category": "personality",
        "percentile": 0.48851640046990125,
        "raw_score": 0.6581953588246281,
        "significant": true
      }, {
        "trait_id": "facet_orderliness",
        "name": "Orderliness",
        "category": "personality",
        "percentile": 0.2854248813415152,
        "raw_score": 0.4755899528631435,
        "significant": true
      }, {
        "trait_id": "facet_self_discipline",
        "name": "Self-discipline",
        "category": "personality",
        "percentile": 0.22645127243423024,
        "raw_score": 0.5348984169455969,
        "significant": true
      }, {
        "trait_id": "facet_self_efficacy",
        "name": "Self-efficacy",
        "category": "personality",
        "percentile": 0.6913003011893397,
        "raw_score": 0.7706676263651483,
        "significant": true
      }]
    }, {
      ...
      "name": "Extraversion",
      "category": "personality",
      "percentile": 0.03782022012419578,
      "raw_score": 0.4717296240555571,
      "significant": true,
      "children": [{
        "trait_id": "facet_activity_level",
        "name": "Activity level",
        "category": "personality",
        "percentile": 0.8027737917072917,
        "raw_score": 0.5839531841814041,
        "significant": true
      }, {
        "trait_id": "facet_assertiveness",
        "name": "Assertiveness",
        "category": "personality",
        "percentile": 0.6183505313794694,
        "raw_score": 0.6591134107546263,
        "significant": true
      }, {
        "trait_id": "facet_cheerfulness",
        "name": "Cheerfulness",
        "category": "personality",
        "percentile": 0.12270565211719675,
        "raw_score": 0.5791571290828612,
        "significant": true
      }, {
        "trait_id": "facet_excitement_seeking",
        "name": "Excitement-seeking",
        "category": "personality",
        "percentile": 0.7539576602035793,
        "raw_score": 0.6327330618285937,
        "significant": true
      }, {
        "trait_id": "facet_friendliness",
        "name": "Outgoing",
        "category": "personality",
        "percentile": 0.2228202983616538,
        "raw_score": 0.5222348479933474,
        "significant": true
      }, {
        "trait_id": "facet_gregariousness",
        "name": "Gregariousness",
        "category": "personality",
        "percentile": 0.0864411233056519,
        "raw_score": 0.3832708749325874,
        "significant": true
      }]
    }, {
      ...
      "name": "Agreeableness",
      "category": "personality",
      "percentile": 0.054342991896686954,
      "raw_score": 0.6784270575108777,
      "significant": true,
      "children": [{
        "trait_id": "facet_altruism",
        "name": "Altruism",
        "category": "personality",
        "percentile": 0.8124735247668096,
        "raw_score": 0.7362078417027069,
        "significant": true
      }, {
        "trait_id": "facet_cooperation",
        "name": "Cooperation",
        "category": "personality",
        "percentile": 0.4762518108219834,
        "raw_score": 0.5758005630573962,
        "significant": true
      }, {
        "trait_id": "facet_modesty",
        "name": "Modesty",
        "category": "personality",
        "percentile": 0.35512632078237594,
        "raw_score": 0.4287720198929477,
        "significant": true
      }, {
        "trait_id": "facet_morality",
        "name": "Uncompromising",
        "category": "personality",
        "percentile": 0.4964436036372386,
        "raw_score": 0.6253902781730728,
        "significant": true
      }, {
        "trait_id": "facet_sympathy",
        "name": "Sympathy",
        "category": "personality",
        "percentile": 0.9382715313262255,
        "raw_score": 0.7222984070083128,
        "significant": true
      }, {
        "trait_id": "facet_trust",
        "name": "Trust",
        "category": "personality",
        "percentile": 0.6695787399518307,
        "raw_score": 0.6038770821717784,
        "significant": true
      }]
    }, {
      ...
      "category": "personality",
      "percentile": 0.43082381742387726,
      "raw_score": 0.4575414836627695,
      "significant": true,
      "children": [{
        "trait_id": "facet_anger",
        "name": "Fiery",
        "category": "personality",
        "percentile": 0.40125947321776934,
        "raw_score": 0.5220392719762249,
        "significant": true
      }, {
        "trait_id": "facet_anxiety",
        "name": "Prone to worry",
        "category": "personality",
        "percentile": 0.6595966496789222,
        "raw_score": 0.6221656047369717,
        "significant": true
      }, {
        "trait_id": "facet_depression",
        "name": "Melancholy",
        "category": "personality",
        "percentile": 0.8274624195061318,
        "raw_score": 0.5082417217746963,
        "significant": true
      }, {
        "trait_id": "facet_immoderation",
        "name": "Immoderation",
        "category": "personality",
        "percentile": 0.23311511878905455,
        "raw_score": 0.47258784272881965,
        "significant": true
      }, {
        "trait_id": "facet_self_consciousness",
        "name": "Self-consciousness",
        "category": "personality",
        "percentile": 0.8419685331591107,
        "raw_score": 0.5994697931496211,
        "significant": true
      }, {
        "trait_id": "facet_vulnerability",
        "name": "Susceptible to stress",
        "category": "personality",
        "percentile": 0.6623855489309667,
        "raw_score": 0.49431572628743503,
        "significant": true
      }]
    }],
    "needs": [{
      ...
      "name": "Challenge",
      "category": "needs",
      "percentile": 0.34145088004398483,
      "raw_score": 0.7134634106891815,
      "significant": true
    }, {
      "trait_id": "need_closeness",
      "name": "Closeness",
      "category": "needs",
      "percentile": 0.09859558641745914,
      "raw_score": 0.7361203448945006,
      "significant": true
    }, {
      "trait_id": "need_curiosity",
      "name": "Curiosity",
      "category": "needs",
      "percentile": 0.9689813908372106,
      "raw_score": 0.8657623082502535,
      "significant": true
    }, {
      "trait_id": "need_excitement",
      "name": "Excitement",
      "category": "needs",
      "percentile": 0.5348450097959973,
      "raw_score": 0.692151831611381,
      "significant": true
    }, {
      "trait_id": "need_harmony",
      "name": "Harmony",
      "category": "needs",
      "percentile": 0.2813419091902981,
      "raw_score": 0.78926956381404,
      "significant": true
    }, {
      "trait_id": "need_ideal",
      "name": "Ideal",
      "category": "needs",
      "percentile": 0.526076623133432,
      "raw_score": 0.6941629863499378,
      "significant": true
    }, {
      "trait_id": "need_liberty",
      "name": "Liberty",
      "category": "needs",
      "percentile": 0.6354095487089614,
      "raw_score": 0.7494815322115702,
      "significant": true
    }, {
      "trait_id": "need_love",
      "name": "Love",
      "category": "needs",
      "percentile": 0.27369302320641825,
      "raw_score": 0.7393906254464253,
      "significant": true
    }, {
      "trait_id": "need_practicality",
      "name": "Practicality",
      "category": "needs",
      "percentile": 0.319737248848609,
      "raw_score": 0.7176525382495603,
      "significant": true
    }, {
      "trait_id": "need_self_expression",
      "name": "Self-expression",
      "category": "needs",
      "percentile": 0.5750747347202526,
      "raw_score": 0.6815698697151246,
      "significant": true
    }, {
      "trait_id": "need_stability",
      "name": "Stability",
      "category": "needs",
      "percentile": 0.21330558958802692,
      "raw_score": 0.7091305293218035,
      "significant": true
    }, {
      "trait_id": "need_structure",
      "name": "Structure",
      "category": "needs",
      "percentile": 0.32287047984053174,
      "raw_score": 0.6836224780604532,
      "significant": true
    }],
    "values": [{
      ...
      "name": "Conservation",
      "category": "values",
      "percentile": 0.07275972154031107,
      "raw_score": 0.5998774828755351,
      "significant": true
    }, {
      "trait_id": "value_openness_to_change",
      "name": "Openness to change",
      "category": "values",
      "percentile": 0.8291551382104356,
      "raw_score": 0.820933431750473,
      "significant": true
    }, {
      "trait_id": "value_hedonism",
      "name": "Hedonism",
      "category": "values",
      "percentile": 0.13271212391866483,
      "raw_score": 0.6670298831271964,
      "significant": true
    }, {
      "trait_id": "value_self_enhancement",
      "name": "Self-enhancement",
      "category": "values",
      "percentile": 0.3513231828857756,
      "raw_score": 0.6895825411701064,
      "significant": true
    }, {
      "trait_id": "value_self_transcendence",
      "name": "Self-transcendence",
      "category": "values",
      "percentile": 0.5029979766204099,
      "raw_score": 0.8330811751693892,
      "significant": true
    }],
...
var script = new _app2.default();
if (DEV) {
  var data = require('./assets/sample.json');
  handleData(data);
...
},{"socket.io-client":"node_modules/socket.io-client/lib/index.js","./src/app":"src/app.js","./assets/sample.json":"assets/sample.json"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/cached.237bed1b.map