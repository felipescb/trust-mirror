...
},{"./url":"node_modules/socket.io-client/lib/url.js","socket.io-parser":"node_modules/socket.io-parser/index.js","./manager":"node_modules/socket.io-client/lib/manager.js","debug":"node_modules/debug/src/browser.js","./socket":"node_modules/socket.io-client/lib/socket.js"}],"src/app.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var processData = console.log;
...
console.log('running');
if (DEV) {
  fetch('/assets/sample.json').then(_app2.default);
} else {
  var socket = _socket2.default.connect("http://localhost:3000/");
  socket.on("go", _app2.default);
}
},{"socket.io-client":"node_modules/socket.io-client/lib/index.js","./app":"src/app.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.e2cde82a.map